...
static const char *fonts[]          = { "Hack Nerd Font Mono:style-Regular:size=11:anitalias=true", "monospace:size=10" };
...
/*static const char *roficmd[] = { "bin/sh", "-c", ./~/.config/rofi/launchers/type-1/launcher.sh, NULL }; */
static const char *termcmd[]  = { "alacritty", NULL };

static const Key keys[] = {
	/* modifier                     key        function        argument */
	{ MODKEY,			XK_b,      spawn,	   SHCMD("xbacklight -inc 10%")},
  ...
  { MODKEY,                       XK_backslash,spawn,        SHCMD("pactl -- set-sink-volume 0 +2%") },
  { MODKEY|ShiftMask,             XK_backslash,spawn,        SHCMD("pactl -- set-sink-volume 0 -2%") },
